...
function Scene() {
  ...
  return (
    <div id="scene" className='flex flex-col h-[80vh]'>
      <div style={{ width: `${sceneWidth + 50}px`, height: `${sceneHeight + 50}px` }} className='mx-4 flex flex-row justify-center items-center'>
        {
          frames.length == 0 ?
